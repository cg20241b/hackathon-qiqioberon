# MUHAMMAD AQIL FARRUKH (QIQI) 5025221158 COMPUTER GRAPHIC B

## HOW TO RUN THE PROGRAM ON MY REPOSITORY

- Clone the repository
- go to the `hackathonqq` directory with `cd hackathonqq`
- run `npm install`
- run `npm run dev`
- enjoy the interactivity by moving the camera with `mouse` or with `w`, `a`, `s`, and `d` on keyboard. 
...
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17481110)
